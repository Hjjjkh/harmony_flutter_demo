...
**文本分段与分词**
- ✅ 智能标点切分（合并过短片段，`TextProcessor.segmentByPunctuation`）
...
1. **添加高亮**
   - 长按显示的文本
   - 选择"添加高亮"
   - 文本被标记并保存，可在“高亮列表”中查看

2. **添加生词**
   - 长按显示的文本
   - 选择"添加生词"
   - 自动查询释义并添加到生词本，可在“生词本”中复习
